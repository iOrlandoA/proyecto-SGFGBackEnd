Area.create(area_type: "Gasto", name: "- Obra en estabulado nuevo Sota", visible: false)
...
Area.create(area_type: "Gasto", name: "- Compra Combustible", visible: false)
...
Area.create(area_type: "Gasto", name: "- Material P/Cerca", visible: false)
